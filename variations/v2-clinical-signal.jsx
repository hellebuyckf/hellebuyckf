...
const DENSITY = {
  spacious: { padX: 88, sectionY: 160, heroY: 120, h1: 110, h2: 50, gap: 32, projGap: 32 },
  standard: { padX: 64, sectionY: 120, heroY: 80,  h1: 94, h2: 42, gap: 24, projGap: 24 },
  dense:    { padX: 44, sectionY: 72,  heroY: 56,  h1: 74,  h2: 34, gap: 16, projGap: 18 },
};
  ...
  const projects = [
    {
      ...
      youtube: 'https://youtu.be/qvpJ9LAJmls',
    },
    {
      tag: 'Clinical · Triage',
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 12, marginTop: 20, alignItems: 'center' }}>
              <a href="https://github.com/hellebuyckf" target="_blank" rel="noopener" aria-label="GitHub" title="github.com/hellebuyckf" style={{
                ...
                fontFamily: vibe.monoFont, fontSize: 13,
              }}
              ...
              <a href="CV_Francois_Hellebuyck.html" target="_blank" rel="noopener" aria-label="CV" style={{
                display: 'inline-flex', alignItems: 'center', gap: 8,
                height: 40, borderRadius: 999, padding: '0 14px',
                border: `1px solid ${C.border}`, background: C.panel,
                color: C.dim, textDecoration: 'none', transition: 'color 200ms, border-color 200ms',
        ...
        <div style={{ marginTop: 36, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: D.projGap }}>
          {projects.map(p => (
            <div key={p.title} style={{
              ...
              {p.github && (
                <div style={{ marginTop: 20, borderTop: `1px solid ${C.border}`, paddingTop: 16, display: 'flex', flexDirection: 'column', gap: 10 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  {p.youtube && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      <span style={{ fontFamily: vibe.monoFont, fontSize: 13, color: C.dim, letterSpacing: '0.04em' }}>Vidéo demo :</span>
                      <a href={p.youtube} target="_blank" rel="noopener" style={{
                        display: 'inline-flex', alignItems: 'center', gap: 8,
                        color: C.dim, textDecoration: 'none', fontSize: 14,
                        fontFamily: vibe.monoFont, letterSpacing: '0.04em',
                        transition: 'color 200ms',
